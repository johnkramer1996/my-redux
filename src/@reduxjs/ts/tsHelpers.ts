...
> = MiddlewareTuple extends [infer Head, ...infer Tail]
  ? ExtractDispatchFromMiddlewareTuple<Tail, Acc & (Head extends Middleware<infer D> ? IsAny<D, {}, D> : {})>
  : Acc
...
export type ExtractStoreExtensions<E> = E extends Tuple<infer EnhancerTuple>
  ...
  ? UnionToIntersection<E[number] extends StoreEnhancer<infer Ext> ? (Ext extends {} ? IsAny<Ext, {}, Ext> : {}) : {}>
  : never
