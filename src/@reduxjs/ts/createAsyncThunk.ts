...
export const createAsyncThunk = /* @__PURE__ */ (() => {
  function createAsyncThunk<Returned, ThunkArg, ThunkApiConfig extends AsyncThunkConfig>(
    ...
    const fulfilled: AsyncThunkFulfilledActionCreator<Returned, ThunkArg, ThunkApiConfig> = createAction(
      ...
      return (dispatch, getState, extra) => {
        ...
        const promise = (async function () {
          ...
          try {
            ...
            dispatch(pending(requestId, arg, options?.getPendingMeta?.({ requestId, arg }, { getState, extra })) as any)
