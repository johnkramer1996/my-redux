...
// type Test01<T1 extends any[], T2 extends any[]> = Reverse<Reverse<T1> extends infer R ? Cast<R, any[]> : never, T2>
...
// export type Params<F extends (...args: any[]) => any> = F extends (...args: infer A) => any ? A : never
...
// type CurryV2<P extends any[], R> = <T extends any[]>(...args: T) => HasTail<P> extends true ? CurryV2<Tail<T>, R> : R
...
// export type Drop<N extends number, T extends any[], I extends any[] = []> = Length<I> extends N
//   ? T
//   : Drop<N, Tail<T>, [...I, any]>

// // Let's test it:
// type test39 = Drop<1, [0, 1, 2, 3]> // [2, 3]
// type test40 = Drop<Length<test39>, [0, 2, 3, 4]> // []
...
// type test42 = Cast<[1, 2, 3], [number, number, number]> // number

// // ---------------------------------------------------------------------------------------

// // And this is our previous curry,
...
// type GapOf<T1 extends any[], T2 extends any[], TN extends any[], I extends any[]> = T1[Pos<I>] extends __
//   ? Append<T2[Pos<I>], TN>
//   : TN
...
//   ...args: Cast<T, Gaps<P>>
// ) => GapsOf<T, P> extends [any, ...any[]] ? CurryV6<GapsOf<T, P> extends infer G ? Cast<G, any[]> : never, R> : R
